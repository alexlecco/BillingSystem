/*
       ...
       Generated on: 11/16/2016 14:0:13.84
...
namespace GeneXus.Programs {
   public class recentlinks : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm022( )
      {
         ...
         {
            context.AddJavascriptSource("recentlinks.js", "?1401388");
         }
      ...
      private void E11022( )
      {
         ...
         AV8Session.Set("RecentLinks", AV11RecentLinksItems.ToXml(false, "LinkList", "BillingSystem"));
         AV9i = 1 ;
         while ( AV9i <= AV11RecentLinksItems.Count )
         {
            AV12RecentLinksItem = ((SdtLinkList_LinkItem)AV11RecentLinksItems.Item(AV9i)) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1401399");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("recentlinks.js", "?1401399");
         }
      ...
      public override void initialize( )
      {
         ...
         AV11RecentLinksItems = new GxObjectCollection( context, "LinkList.LinkItem", "BillingSystem", "SdtLinkList_LinkItem", "GeneXus.Programs");
